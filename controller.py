    ...
    while True:
        ...
        match choice:
            ...
            case 4:
                ...
                view.print_message(text.contact_save_successful(
                    contact[0], text.contact_operation[0]))
            case 5:
            ...
            case 6:
                if search_block(pb, text.for_edit):
                    ...
                    view.print_message(text.contact_save_successful(
                        new_contact[0], text.contact_operation[2]))
            case 7:
                if search_block(pb, text.for_delete):
                    del_id = int(view.input_request(text.input_del_id))
                    name = pb.del_contact(del_id)[del_id[0]]
                    view.print_message(text.file_save_successful(
                        name, text.contact_operation[1]))
            case 8:
